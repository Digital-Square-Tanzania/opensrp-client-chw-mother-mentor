...
public class MotherMentorResultsViewProvider implements RecyclerViewProvider<MotherMentorResultsViewProvider.RegisterViewHolder> {
    ...
    public MotherMentorResultsViewProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
