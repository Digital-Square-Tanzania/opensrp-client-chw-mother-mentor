...
public class BaseMotherMentorContactFragment extends BaseRegisterFragment implements MotherMentorRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        MotherMentorRegisterProvider tbMotherMentorRegisterProvider = new MotherMentorRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, tbMotherMentorRegisterProvider, context().commonrepository(this.tablename));
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.mothermentor));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public MotherMentorRegisterFragmentContract.Presenter presenter() {
        return (MotherMentorRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseMotherMentorRegisterContactFragmentPresenter(this, new BaseMotherMentorContactsRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseMotherMentorProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
