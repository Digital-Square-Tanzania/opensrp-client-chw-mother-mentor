...
public class MotherMentorMobilizationRegisterProvider extends MotherMentorResultsViewProvider {

    protected Set<org.smartregister.configurableviews.model.View> visibleColumns;

    public MotherMentorMobilizationRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
