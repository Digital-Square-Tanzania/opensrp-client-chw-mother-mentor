...
import org.smartregister.chw.mothermentor.fragment.BaseMotherMentorVisitFragment;
 ...
 */
public class BaseMotherMentorVisitAction {
    ...
    private BaseMotherMentorVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private MotherMentorVisitActionHelper mothermentorVisitActionHelper;
    private Map<String, List<VisitDetail>> details;
    private Context context;
    private Validator validator;

    private BaseMotherMentorVisitAction(Builder builder) throws ValidationException {
        ...
        this.mothermentorVisitActionHelper = builder.mothermentorVisitActionHelper;
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    MotherMentorJsonFormUtils.populateForm(jsonObject, details);
                }

                jsonPayload = jsonObject.toString();
            }

            if (mothermentorVisitActionHelper != null) {
                mothermentorVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = mothermentorVisitActionHelper.getPreProcessed();
                ...
                String sub_title = mothermentorVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = mothermentorVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        mothermentorVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = mothermentorVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = mothermentorVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = mothermentorVisitActionHelper.postProcess(jsonPayload);
        }

        mothermentorVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseMotherMentorVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseMotherMentorVisitFragment destinationFragment) {
    ...
    public MotherMentorVisitActionHelper getMotherMentorVisitActionHelper() {
        return mothermentorVisitActionHelper;
    }

    public void setMotherMentorVisitActionHelper(MotherMentorVisitActionHelper mothermentorVisitActionHelper) {
        this.mothermentorVisitActionHelper = mothermentorVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getMotherMentorVisitActionHelper() != null) {
            setActionStatus(getMotherMentorVisitActionHelper().evaluateStatusOnPayload());
        }
    }
    ...
    public interface MotherMentorVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseMotherMentorVisitAction mothermentorVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseMotherMentorVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(MotherMentorVisitActionHelper mothermentorVisitActionHelper) {
            this.mothermentorVisitActionHelper = mothermentorVisitActionHelper;
            return this;
        }
        ...
        public BaseMotherMentorVisitAction build() throws ValidationException {
            return new BaseMotherMentorVisitAction(this);
        }
    }
