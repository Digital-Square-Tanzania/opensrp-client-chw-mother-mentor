package org.smartregister.chw.mothermentor.fragment;
...
import org.smartregister.chw.mothermentor.adapter.MotherMentorMobilizationRegisterAdapter;
import org.smartregister.chw.mothermentor.dao.MotherMentorMobilizationDao;
...
import org.smartregister.chw.mothermentor.presenter.MotherMentorMobilizationRegisterFragmentPresenter;
import org.smartregister.chw.mothermentor.provider.MotherMentorMobilizationRegisterProvider;
...
public class BaseMotherMentorMobilizationRegisterFragment extends BaseMotherMentorRegisterFragment {

    protected Toolbar toolbar;
    protected LinearLayout emptyViewLayout;
    private MotherMentorMobilizationRegisterAdapter adapter;

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        MotherMentorMobilizationRegisterProvider mobilizationRegisterProvider = new MotherMentorMobilizationRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    protected void setUpAdapter() {
        List<MotherMentorMobilizationModel> tbMotherMentorMobilizationModels = MotherMentorMobilizationDao.getMobilizationSessions();
        if (tbMotherMentorMobilizationModels != null && !tbMotherMentorMobilizationModels.isEmpty()) {
            adapter = new MotherMentorMobilizationRegisterAdapter(tbMotherMentorMobilizationModels, requireActivity());
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            titleView.setText(getString(R.string.mothermentor_sessions));
    ...
    protected void initializePresenter() {
        ...
        presenter = new MotherMentorMobilizationRegisterFragmentPresenter(this, new BaseMotherMentorRegisterFragmentModel(), viewConfigurationIdentifier);
    }
    ...
    protected void refreshSyncProgressSpinner() {
        ...
        if (syncButton != null) {
            ...
            syncButton.setOnClickListener(view -> {
                JSONObject form;
                try {
                    form = (new FormUtils()).getFormJsonFromRepositoryOrAssets(requireActivity(), Constants.FORMS.MOTHERMENTOR_MOBILIZATION_SESSION);
                    if (form != null) {
