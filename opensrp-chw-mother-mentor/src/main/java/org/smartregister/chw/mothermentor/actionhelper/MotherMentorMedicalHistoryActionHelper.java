...
public class MotherMentorMedicalHistoryActionHelper implements BaseMotherMentorVisitAction.MotherMentorVisitActionHelper {
    ...
    public MotherMentorMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
