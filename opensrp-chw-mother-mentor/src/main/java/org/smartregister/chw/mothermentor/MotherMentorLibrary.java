package org.smartregister.chw.mothermentor;
...
public class MotherMentorLibrary {
    private static MotherMentorLibrary instance;
    ...
    public void setSubmitOnSave(boolean submitOnSave) {
        MotherMentorLibrary.submitOnSave = submitOnSave;
    }
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new MotherMentorLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static MotherMentorLibrary getInstance() {
        if (instance == null) {
    ...
    private MotherMentorLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
