...
public interface BaseMotherMentorVisitContract {
    interface View extends VisitView {
        ...
        void startForm(BaseMotherMentorVisitAction mothermentorHomeVisitAction);

        void startFormActivity(JSONObject jsonForm);

        void startFragment(BaseMotherMentorVisitAction mothermentorHomeVisitAction);
        ...
        Map<String, BaseMotherMentorVisitAction> getMotherMentorVisitActions();
        ...
        void initializeActions(LinkedHashMap<String, BaseMotherMentorVisitAction> map);
    ...
    interface Interactor {
        ...
        void submitVisit(boolean editMode, String memberID, Map<String, BaseMotherMentorVisitAction> map, InteractorCallBack callBack);
    }
    ...
    interface InteractorCallBack {
        ...
        void preloadActions(LinkedHashMap<String, BaseMotherMentorVisitAction> map);
