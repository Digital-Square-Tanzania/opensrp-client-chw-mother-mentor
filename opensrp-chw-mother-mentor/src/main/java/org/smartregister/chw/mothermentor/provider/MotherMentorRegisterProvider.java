package org.smartregister.chw.mothermentor.provider;
...
public class MotherMentorRegisterProvider implements RecyclerViewProvider<MotherMentorRegisterProvider.RegisterViewHolder> {
    ...
    public MotherMentorRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        if ("0".equals(Utils.getValue(commonPersonObjectClient.getColumnmaps(), DBConstants.KEY.IS_ANC_CLOSED, false))) {
            ...
            return MotherMentorUtil.getGenderTranslated(context, gender);
        }
    }
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseMotherMentorRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setOnClickListener(onClickListener);
            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseMotherMentorRegisterFragment.FOLLOW_UP_VISIT);
...
//        implement
    ...
    public RegisterViewHolder createViewHolder(ViewGroup parent) {
        View view = inflater.inflate(R.layout.mothermentor_register_list_row, parent, false);
