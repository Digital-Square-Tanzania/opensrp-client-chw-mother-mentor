...
public class BaseMotherMentorProfileActivityTest {
    @Mock
    public BaseMotherMentorProfileActivity baseTestProfileActivity;

    @Mock
    public MotherMentorProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseMotherMentorProfileActivity activity = new BaseTestMotherMentorProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseTestMotherMentorProfileActivity());
