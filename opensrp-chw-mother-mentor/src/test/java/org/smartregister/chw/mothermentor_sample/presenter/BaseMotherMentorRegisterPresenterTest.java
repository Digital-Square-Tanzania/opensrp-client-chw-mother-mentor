...
@PrepareForTest(BaseMotherMentorRegisterPresenter.class)
public class BaseMotherMentorRegisterPresenterTest {
    @Mock
    protected BaseMotherMentorRegisterPresenter baseMotherMentorRegisterPresenter;

    @Mock
    protected MotherMentorRegisterContract.Interactor interactor;
    @Mock
    protected MotherMentorRegisterContract.Model model;
    @Mock
    protected MotherMentorRegisterContract.View baseView;
    private BaseMotherMentorRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseMotherMentorRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseMotherMentorRegisterPresenter, "getView"));
    }
