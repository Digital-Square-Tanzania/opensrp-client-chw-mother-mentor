...
public class BaseMotherMentorRegisterActivityTest {
    @Mock
    public Intent data;
    @Mock
    private BaseMotherMentorRegisterActivity baseTestRegisterActivity = new BaseMotherMentorRegisterActivity();
