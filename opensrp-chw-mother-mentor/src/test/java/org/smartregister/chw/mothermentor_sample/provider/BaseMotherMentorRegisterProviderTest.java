package org.smartregister.chw.mothermentor_sample.provider;
...
public class BaseMotherMentorRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public MotherMentorRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private MotherMentorRegisterProvider testRegisterProvider;
    ...
    public void isAncClosed() throws Exception {
        ...
        MotherMentorRegisterProvider provider = Mockito.spy(new MotherMentorRegisterProvider(activity, listener, listener, null));
    ...
    public void updateMemberGender() throws Exception {
        Activity activity = Mockito.mock(Activity.class);
        Resources resources = Mockito.mock(Resources.class);
        MotherMentorRegisterProvider provider = new MotherMentorRegisterProvider(activity, listener, listener, null);
        Map<String, String> map = new HashMap<>();
