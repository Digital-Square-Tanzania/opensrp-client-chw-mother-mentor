...
@PrepareForTest(BaseMotherMentorCallDialogFragment.class)
public class BaseMotherMentorCallDialogFragmentTest {
    @Spy
    public BaseMotherMentorCallDialogFragment baseTestCallDialogFragment;
    ...
    @Mock
    public MemberObject mothermentorMemberObject;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        Whitebox.setInternalState(BaseMotherMentorCallDialogFragment.class, "MEMBER_OBJECT", mothermentorMemberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Mockito.when(mothermentorMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(mothermentorMemberObject.getFamilyHead()).thenReturn("123456");
    ...
    public void setCallTitleCareGiver() throws Exception {
        ...
        Mockito.when(mothermentorMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(mothermentorMemberObject.getPrimaryCareGiver()).thenReturn("123456");
    ...
    public void setCallTitle() throws Exception {
        ...
        Mockito.when(mothermentorMemberObject.getBaseEntityId()).thenReturn("1");
        Mockito.when(mothermentorMemberObject.getFamilyHead()).thenReturn("123456");

        Mockito.when(viewGroup.findViewById(view.getId())).thenReturn(textView);

        Whitebox.invokeMethod(baseTestCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message MotherMentor Client", textView.getText());
    }

    @Test(expected = Exception.class)
    public void initUI() throws Exception {
        Mockito.when(mothermentorMemberObject.getPhoneNumber()).thenReturn("123456789");
