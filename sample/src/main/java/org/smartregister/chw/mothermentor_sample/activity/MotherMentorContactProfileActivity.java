...
import static org.smartregister.chw.mothermentor.util.Constants.EVENT_TYPE.MOTHERMENTOR_CONTACT_VISIT;
import static org.smartregister.chw.mothermentor.util.Constants.EVENT_TYPE.MOTHER_MENTOR_OBSERVATIONS_RESULT;
import static org.smartregister.chw.mothermentor.util.Constants.JSON_FORM_EXTRA.ENCOUNTER_TYPE;
import static org.smartregister.chw.mothermentor.util.Constants.JSON_FORM_EXTRA.EVENT_TYPE;
...
public class MotherMentorContactProfileActivity extends BaseMotherMentorProfileActivity {
    ...
    public static void startMe(Activity activity, String baseEntityID) {
        Intent intent = new Intent(activity, MotherMentorContactProfileActivity.class);
    ...
    protected void setupButtons() {
        ...
        if (StringUtils.isNotBlank(eventType)) {
            if (eventType.equalsIgnoreCase(MOTHERMENTOR_CONTACT_VISIT)) {
        ...
        if(StringUtils.isNotBlank(encounterType)){
            if(encounterType.equalsIgnoreCase(MOTHER_MENTOR_OBSERVATIONS_RESULT)){
                textViewRecordTbContactVisit.setVisibility(View.VISIBLE);
                textViewRecordTbContactVisit.setText(R.string.record_mothermentor_contact_visit_followup);
            }
            textViewRecordTbContactVisit.setVisibility(View.VISIBLE);
