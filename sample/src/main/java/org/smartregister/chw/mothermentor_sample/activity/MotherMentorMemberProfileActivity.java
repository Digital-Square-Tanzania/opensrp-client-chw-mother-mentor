...
public class MotherMentorMemberProfileActivity extends BaseMotherMentorProfileActivity {
    ...
    public static void startMe(Activity activity, String baseEntityID) {
        Intent intent = new Intent(activity, MotherMentorMemberProfileActivity.class);
...
//        textViewRecordMotherMentor.setText("Record Mother Mentor Visit");

        if (StringUtils.isNotBlank(encounterType)) {
            if (encounterType.equalsIgnoreCase(Constants.EVENT_TYPE.MOTHER_MENTOR_SCREENING)) {
