package org.smartregister.chw.mothermentor_sample.repository;
...
import org.smartregister.chw.mothermentor_sample.BuildConfig;
import org.smartregister.chw.mothermentor_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        MotherMentorLibrary.getInstance().visitRepository().createTable(database);
        MotherMentorLibrary.getInstance().visitDetailsRepository().createTable(database);
